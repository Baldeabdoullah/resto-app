        ...
        <main class="m-2 p-8 w-full">
            ...
            <div>
                ...
                @if (session()->has('danger'))
                    <div class="p-4 mb-4 text-sm text-red-500 bg-red-100 round-lg dark:bg-red-500 dark:text-red-700 "
                        role="alert">
                ...
                @if (session()->has('success'))
                    <div class="p-4 mb-4 text-sm text-green-500 bg-green-100 round-lg dark:bg-green-500 dark:text-green-700 "
                        role="alert">
                ...
                @if (session()->has('warning'))
                    <div class="p-4 mb-4 text-sm text-yellow-500 bg-yellow-100 round-lg dark:bg-yellow-500 dark:text-yellow-700 "
                        role="alert">
