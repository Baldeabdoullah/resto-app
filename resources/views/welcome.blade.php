<x-guest-layout>
    ...
    <div class="container max-w-lg px-4 py-32 mx-auto text-left bg-center bg-no-repeat bg-cover md:max-w-none md:text-center"
        ...
        <h1
            class="font-mono text-3xl font-extrabold text-transparent text-white bg-clip-text bg-gradient-to-r from-green-400 to-blue-500 md:text-center sm:leading-none lg:text-5xl">
            <span class="inline md:block">Bienvenue au restaurant Delicia</span>
        </h1>
        <div class="mx-auto mt-2 text-green-50 md:text-center lg:text-lg">
            Des plats sur place ou a emporter . faites vos reservations
        </div>
    ...
    <section class="px-2 py-32 bg-white md:px-0">
        <div class="container items-center max-w-6xl px-8 mx-auto xl:px-5">
            ...
            > -->
                        <h3 class="text-xl">Qui sommes nous ?
                        </h3>
                        <h2 class="text-4xl text-green-600">Bienvenue</h2>
                        <!-- </h1> -->
                        <p class="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">
                            Bien manger est plus q'un choix c'est tout un mode de vie. la nourriture est le premier
                            medicament du corps. C'est
                            pourquoi depuis plus de 10 ans la baguettes Magiques mets a votre dispositions des produits
                            sains sans produits
                            chimiques produits localement.
                        </p>
                ...
                <div class="w-full md:w-1/2">
                    <div class="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                        <img src="{{ asset('images/infos.jpg') }}" />
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="order-1 w-full px-3 lg:w-1/2 lg:order-0">
                    <div class="w-full lg:max-w-md">
                        ...
                        <h2
                            ...
                            Pourquoi choisire Delicia?</h2>

                        <p class="mb-4 font-medium tracking-tight text-gray-400 xl:mb-6">Delicia est un consortium
                            constitué d'agriculteurs d'eleveurs de restaurants et de transformation de produits agricol
                            fondé en 1987. Nous nous proposons de vous assurer des plats delicieux et des produits faits
                            à partir des ingrédients
                            locaux. Tous nos produits proviennent de nos fermes d'élevages et de nos plantations
                            agricoles. Ainsi, nous colaborons
                            avec des producteurs(agriculteurs, pisiculteur, eleveurs) pour mettre en valeurs la cuisine
                            local et cela depuis plus de
                            30 ans.</p>
                        <ul>
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                                ...
                                <span class="font-medium text-gray-500">Livraison rapide</span>
                            </li>
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                                ...
                                <span class="font-medium text-gray-500">Paiement facilité</span>
                            </li>
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                                <svg class="w-8 h-8 text-gray-500" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span class="font-medium text-gray-500">Application 100% securise</span>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="w-full px-3 mb-12 lg:w-1/2 order-0 lg:order-1 lg:mb-0"><img
                        class="mx-auto sm:max-w-sm lg:max-w-full rounded " src="{{ asset('images/menu6.jpg') }}"
